...
+ Introducción a Adobe Campaign {#start}
  ...
  + {hide-from-toc}[Descubra la interfaz](get-started/user-interface.md)
  ...
  + [Seleccionar atributos y añadirlos a favoritos](get-started/attributes.md)
  ...
  + {hide-from-toc}[Ayuda contextual con tecnología de IA](get-started/using-ai.md)
...
+ Mensajes y envíos {#msg}
  ...
  + SMS {#sms}
    ...
    + [Creación de una entrega de SMS](sms/create-sms.md)
  ...
  + Correo directo {#direct-mail}
    ...
    + [Creación de una entrega de correo directo](direct-mail/create-direct-mail.md)
...
+ Administración de contenido {#content}
  ...
  + Reutilizar contenido {#manage-reusable-content}
    + Plantillas de contenido {#content-templates}
      ...
      + [Bloqueo del contenido en las plantillas de correo electrónico](content/content-locking.md)
  ...
  + Generar contenido {#ai-assistant}
    ...
    + Marcas {#ai-assistant}
      ...
      + [Creación y administración de modelos generativos](content/generative-models.md)
...
+ Flujos de trabajo {#wf}
  ...
  + Trabajo con actividades del flujo de trabajo {#design-workflows}
    ...
    + [Carga de datos (RDBMS)](workflows/activities/data-loading-rdbms.md)
    ...
    + [Finalizar](workflows/activities/end.md)
    ...
    + [Transferencia de archivo](workflows/activities/transfer-file.md)
...
+ Consultar la base de datos {#query-database}
  ...
  + {hide-from-toc}[Muestras de consultas](query/query-samples.md)
...
+ Creación de informes {#reports}
  ...
  + Sistema de informes dinámicos {#dynamic-reporting}
    ...
    + Acerca del sistema de informes {#about-reporting}
      ...
      + [Cálculo de indicador](reporting/dynamic-reporting/indicator-calculation.md)
      + [Solución de problemas](reporting/dynamic-reporting/troubleshooting.md)
    + Lista de informes {#list-of-reports}
      + [Definición del período de informe](reporting/dynamic-reporting/defining-the-report-period.md)
      + [Resumen de devoluciones](reporting/dynamic-reporting/bounce-summary.md)
      + [Desglose por dominios](reporting/dynamic-reporting/breakdown-by-domains.md)
      + [Reclamaciones](reporting/dynamic-reporting/complaints.md)
      + [Resumen de entregas](reporting/dynamic-reporting/delivery-summary.md)
      + [Rendimiento del envío](reporting/dynamic-reporting/delivery-throughput.md)
      + [Rechazos y correos que no se pueden entregar](reporting/dynamic-reporting/non-deliverables-and-bounces.md)
      + [Aperturas](reporting/dynamic-reporting/opens.md)
      + [Indicadores de seguimiento](reporting/dynamic-reporting/tracking-indicators.md)
      + [Bajas](reporting/dynamic-reporting/unsubscriptions.md)
      + [URL y flujos de clics](reporting/dynamic-reporting/urls-and-click-streams.md)
    + Personalización de informes {#customizing-reports}
      + [Adición de paneles](reporting/dynamic-reporting/adding-panels.md)
