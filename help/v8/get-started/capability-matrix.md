...
Con la interfaz de usuario web de Campaign, puede crear, diseñar y enviar **correo electrónico**, **SMS** y **notificaciones push** y medir su impacto utilizando varios informes específicos, tal como se detalla a continuación [en esta sección](../msg/gs-messages.md). Sin embargo, actualmente **no** están disponibles los siguientes canales: in-app, correo directo, LINE, centro de llamadas/canal personalizado, marketing social con X (Twitter).
...
* **Correo directo** El canal de correo directo le permite enviar una correspondencia física a sus clientes, proveedores u otros, como avisos, facturas, extractos, ofertas de marketing y mucho más. Este canal solo está disponible en la consola del cliente.  [Más información](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/sending-direct-mail/about-direct-mail-channel.html?lang=es){target="_blank"}
...
Actualmente, las funciones de mensajería transaccional que están incluidas en el paquete de productos del Centro de mensajería no están disponibles en la nueva interfaz de usuario web de Campaign.

Examine la [documentación de la versión 8 de Campaign (consola de cliente)](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/real-time/transactional.html?lang=es){target="_blank"} y obtenga más información sobre las funcionalidades de mensajería en tiempo real, como las siguientes:
...
Las tipologías son conjuntos de reglas de tipología que se ejecutan durante la fase de preparación para poder aplicar fácilmente varias reglas de filtrado a un envío a la vez. Permiten a los especialistas en marketing estandarizar las prácticas comerciales en todos los envíos, ya que les permiten controlar, filtrar y priorizar el envío de entregas.
...
* Creación de reglas de control. [Más información](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/control-rules.html?lang=es){target="_blank"}
...
* Creación de reglas de filtrado. [Más información](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/filtering-rules.html?lang=es){target="_blank"}
* Administración de reglas de tipología. [Más información](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/apply-rules.html?lang=es){target="_blank"}
...
* Programación JavaScript para la creación de reglas de tipología. [Más información](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/pressure-rules.html?lang=es#use-cases-on-pressure-rules){target="_blank"}
...
Más información acerca de las actividades de flujo de trabajo disponibles en la documentación de flujo de trabajo de la documentación de la versión 8 de Adobe Campaign (consola) [aquí](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/activities.html?lang=es){target="_blank"}.
...
Más información sobre cómo administrar un catálogo de ofertas en la [Documentación de la versión 8 de Campaign (consola de cliente)](https://experienceleague.adobe.com/docs/campaign/campaign-v8/offers/interaction.html?lang=es){target="_blank"}.
...
Algunas funciones solo están disponibles desde la consola del cliente. Examine los vínculos proporcionados para examinar la versión 8 de [Documentación de Campaign (consola de cliente)](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=es){target="_blank"} y obtenga más información.

* Informe de entregabilidad y renderización de la bandeja de entrada integrados. [Más información](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/deliverability-management/inbox-rendering.html?lang=es){target="_blank"}
...
Para obtener más información, examine los vínculos que se proporcionan en la [Documentación de la versión 8 de Campaign (consola de cliente)](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=es){target="_blank"}.

* **Cuentas externas** Adobe Campaign incluye un conjunto de cuentas externas predefinidas para conectarse con sistemas externos. Como administrador del sistema de Campaign, puede crear y administrar cuentas externas solo desde la consola del cliente.[Más información](https://experienceleague.adobe.com/docs/campaign/campaign-v8/config/configuration/external-accounts.html?lang=es){target="_blank"}
* **Creación y extensión de esquemas**. La creación, modificación y extensión de esquemas está restringida a usuarios avanzados. Estas funcionalidades solo están disponibles desde la consola del cliente. [Más información](https://experienceleague.adobe.com/docs/campaign/campaign-v8/developer/shemas-forms/schemas.html?lang=es){target="_blank"}
* Actividades de flujo de trabajo de **Administración de datos**. La administración de datos combina un conjunto de actividades para resolver problemas complejos de segmentación mediante la oferta de herramientas más eficientes y flexibles. Estas actividades incluyen: cargar datos, extracción (archivo), actualizar datos, editar esquema, importar/exportar flujos de trabajo técnicos. Solo están disponibles en la consola del cliente. [Más información](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/wf-type/targeting-workflows.html?lang=es#data-management){target="_blank"}
...
Obtenga información sobre cómo administrar aprobaciones en flujos de trabajo en la versión 8 de [Documentación de Campaign (consola de cliente)](https://experienceleague.adobe.com/docs/campaign/automation/workflows/executing-a-workflow/define-approvals.html?lang=es){target="_blank"}.


Obtenga información sobre cómo administrar las aprobaciones de entrega, contenido y público destinatario en las campañas de la versión 8 de la [Documentación de Campaign (consola de cliente)](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-approval.html?lang=es){target="_blank"}.
