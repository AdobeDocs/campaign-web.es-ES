...
>abstract="Para guardar contenido como un fragmento visual, seleccione los elementos que desea incluir en el fragmento, incluidos los campos de personalización y el contenido dinámico. Solo se pueden seleccionar secciones adyacentes. No se pueden seleccionar estructuras vacías u otros fragmentos de contenido. El contenido se convierte en un fragmento independiente, se añade a la lista de fragmentos y se puede acceder a él desde el menú dedicado. Este fragmento se puede utilizar al crear cualquier correo electrónico o plantilla de contenido dentro de Campaign."
