...
1. En el **[!UICONTROL Vínculo]** del campo **[!UICONTROL Configuración de componentes]**, añada la dirección URL a la que quiere que se redirija a su audiencia al hacer clic en el botón .
