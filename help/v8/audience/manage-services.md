...
>abstract="Utilice Adobe Campaign para crear y monitorizar sus servicios, como los boletines informativos, y comprobar las suscripciones o las bajas en estos servicios. Las suscripciones solo se aplican al envío de correo electrónico y SMS."
...
>abstract="Haga clic en **Calcular** para obtener el número total de suscriptores de este servicio."
