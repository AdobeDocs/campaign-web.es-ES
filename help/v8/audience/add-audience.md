...
1. La sección de filtro le permite acceder a las opciones de filtrado para restringir la lista de audiencias. Para ello, haga clic en **Agregar reglas** para acceder al generador de reglas, que permite crear filtros avanzados para la lista de audiencias. [Aprenda a utilizar el generador de reglas](../query/query-modeler-overview.md)
