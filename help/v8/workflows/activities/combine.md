...
Esta actividad le permite realizar la segmentación de la población entrante. Por lo tanto, puede combinar varias poblaciones, excluir parte de ellas o solo mantener datos comunes para varios públicos destinatarios. Estos son los tipos de segmentación disponibles:
...
Para la **Unión**, debe seleccionar el **Tipo de reconciliación** para definir cómo se gestionan los duplicados:
...
Para la **Intersección**, debe seguir estos pasos adicionales:
...
Para la **Exclusión**, debe seguir estos pasos adicionales:
...
En el siguiente ejemplo, añadimos una **unión** que recupera todos los perfiles de las dos consultas: personas entre 18 y 27 años y personas entre 34 y 40 años.
