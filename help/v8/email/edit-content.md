...
* Añada variantes de idioma a los envíos. [Más información](../msg/multilingual.md)
...
1. [Obtenga información sobre cómo obtener una vista previa y probar tu correo electrónico](../preview-test/preview-test.md).
