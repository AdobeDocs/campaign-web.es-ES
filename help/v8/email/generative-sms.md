---
audience: end-user
title: SMS con el asistente de IA en la web de Adobe Campaign para la aceleración de contenido
...
# Generación de SMS con el asistente de IA en Adobe Campaign Web: acelerador de contenido {#generative-sms}
