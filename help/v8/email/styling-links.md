...
1. En la ficha **[!UICONTROL Configuración]**, marque **[!UICONTROL Subrayar vínculo]** para subrayar la etiqueta.
   ...
   ![Captura de pantalla que muestra la opción Vínculo de subrayado en la pestaña Configuración.](assets/link_1.png){zoomable="yes"}
...
1. Elija cómo se redirige a su público con la lista desplegable **[!UICONTROL Destinatario]**:
   ...
   * **[!UICONTROL Top]**: abre el vínculo en todo el cuerpo de la ventana.
   ...
   ![Captura de pantalla que muestra las opciones desplegables de Target en la pestaña Configuración.](assets/link_2.png){zoomable="yes"}

1. Para cambiar el color del vínculo, haga clic en **[!UICONTROL Color del vínculo]** en la pestaña **[!UICONTROL Estilos]**.

   ![Captura de pantalla que muestra la opción Color del vínculo en la pestaña Estilos.](assets/link_3.png){zoomable="yes"}
