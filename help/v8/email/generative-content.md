...
1. Clic **[!UICONTROL Cargar recurso de marca]** para añadir cualquier recurso de marca que contenga contenido que pueda proporcionar contexto adicional, utilice el asistente de IA o seleccione uno cargado anteriormente.
...
1. Adapte el indicador con las diferentes opciones:
   ...
   * **[!UICONTROL Longitud]**: elija la longitud deseada del contenido mediante el regulador de intervalo.
...
1. Seleccione una **[!UICONTROL Componente Texto]** para dirigirse únicamente a un contenido específico. y acceder a **[!UICONTROL Asistente de IA]** menú.
...
Aprenda a utilizar el asistente de IA para generar correos electrónicos, textos o imágenes completos.
