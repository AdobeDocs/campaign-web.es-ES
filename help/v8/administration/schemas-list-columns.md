...
>additional-url="https://experienceleague.adobe.com/docs/campaign-web/v8/conf/schemas/schemas-custom-filters.html" text="Añadir filtros personalizados"
...
1. Elija **[!UICONTROL Seleccionar columnas]**.
   ![Configuración de columnas de lista](assets/schemas-list-columns2.png)

1. Seleccione los atributos que desee mostrar en las vistas de lista y confirme.

   ![Configuración de columnas de lista](assets/schemas-list-columns.png)
...
1. Vaya al menú **Perfiles** para acceder a la vista de la lista de perfiles. Verá que se muestran las pestañas nuevas. Puede agregar más columnas si es necesario.
   ...
   ![Configuración de columnas de lista](assets/schemas-list-columns3.png)

>[!NOTE]
>
>También puede agregar campos de filtro de acceso rápido en el panel Filtros de la vista de lista. Para obtener más información, consulte [Agregar filtros personalizados](schemas-custom-filters.md).
