...
description: Obtenga información sobre cómo configurar cuentas externas de Hadoop
...
# Cuenta externa de Hadoop {#external-hadoop}
...
Para configurar la cuenta externa **[!UICONTROL Hadoop]**, rellene los campos siguientes:
